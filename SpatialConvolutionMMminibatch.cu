...
static int cunn_SpatialConvolutionMMminibatch_updateOutput(lua_State *L) {
  // Input
...
static int cunn_SpatialConvolutionMMminibatch_updateGradInput(lua_State *L) {
  // Inputs
  THCudaTensor *input = (THCudaTensor *)luaT_checkudata(L, 2, "torch.CudaTensor");
...
static int cunn_SpatialConvolutionMMminibatch_accGradParameters(lua_State *L) {
  // Inputs
  THCudaTensor *input = (THCudaTensor *)luaT_checkudata(L, 2, "torch.CudaTensor");
  THCudaTensor *gradOutput = (THCudaTensor *)luaT_checkudata(L, 3, "torch.CudaTensor");
...
static const struct luaL_Reg cunn_SpatialConvolutionMMminibatch__ [] = {
  {"SpatialConvolutionMMminibatch_updateOutput", cunn_SpatialConvolutionMMminibatch_updateOutput},
  {"SpatialConvolutionMMminibatch_updateGradInput", cunn_SpatialConvolutionMMminibatch_updateGradInput},
  {"SpatialConvolutionMMminibatch_accGradParameters", cunn_SpatialConvolutionMMminibatch_accGradParameters},
  {NULL, NULL}
};

void cunn_SpatialConvolutionMMminibatch_init(lua_State *L)
{
	luaL_openlib(L, "jzt", cunn_SpatialConvolutionMMminibatch__, 0);
}
