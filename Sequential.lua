...
function Sequential:updateGradInput(input, gradOutput, num_modules)
   num_modules = num_modules or #self.modules
   local currentGradOutput = gradOutput
   local currentModule = self.modules[num_modules]
...
function Sequential:accGradParameters(input, gradOutput, scale, num_modules)
   scale = scale or 1
   num_modules = num_modules or #self.modules
   local currentGradOutput = gradOutput
   local currentModule = self.modules[num_modules]
